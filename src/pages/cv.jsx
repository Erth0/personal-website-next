  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Thank you for checking out my CV"
        />
      </Head>
        <div className="max-w-5xl p-6 mx-auto bg-white dark:bg-zinc-900 page print:max-w-letter md:max-w-letter md:h-letter xsm:p-8 sm:p-9 md:p-16">
            <header className="flex items-center mb-8 md:mb-11">
                <div className="px-3 mr-5 text-base font-medium leading-none text-white bg-teal-600 rounded initials-container"
                    style={{
                        paddingBottom: '0.6875rem',
                        paddingTop: '0.6875rem'
                        }}>
                    <div className="text-center initial" style={{ paddingBottom: '0.1875rem' }}>E</div>
            ...
            <div className="col-gap-md md:h-letter-col print:h-letter-col col-fill-auto">
                    ...
                    <div className="break-inside-avoid">
                        ...
                        <section className="mb-4 break-inside-avoid">
                            ...
                            <p className="mt-2 text-zinc-600 dark:text-zinc-400 text-base">
                                As a senior full stack web developer,
                                I have accrued a wealth of knowledge and skills that I put to use developing cutting-edge platforms.
                                I continue to expand my knowledge and skills constantly,
                                figuring out new ways to push the limits of web technology.
                                Passionate about computer science,
                                I have learned more and more since completing my computer science degree.
                                I am a strong believer in the value of ongoing education, embracing a mindset grounded in curiosity and vigor.
                                Pushing myself, I strive to do projects that I can be proud of.
                            </p>
                        </section>
                    </div>
                </section>
                ...
                <section className="grid grid-cols-1 mt-8 print:col-count-1 first:mt-0">
                    <div className="break-inside-avoid">
                        <h2 className="mb-4 text-sm font-bold tracking-widest text-teal-700">
                            EXPERIENCE
                        </h2>
                        <section className="mb-4 break-inside-avoid">
                            <header>
                                ...
                                <p className="text-zinc-600 dark:text-zinc-300 text-md">
                                    Jun 2018 – Present | Lead Software Engineer
                                </p>
                            </header>
                            <p className="mt-2 text-zinc-600 dark:text-zinc-400 text-base">
                    ...
                    <section className="mb-4 break-inside-avoid">
                        ...
                        <ul className="">
                            <li className="mt-2 text-zinc-600 dark:text-zinc-400 text-base">
                                <span className="absolute -ml-3 transform -translate-y-px select-none sm:-ml-3">›</span>
                            ...
                            <li className="mt-2 text-zinc-600 dark:text-zinc-400 text-base">
                                <span className="absolute -ml-3 transform -translate-y-px select-none sm:-ml-3">›</span>
                                Gave weekly reports to executive management regarding current developments, and tracked changes in existing software.
                            </li>
                        </ul>
                    </section>
                    <section className="mb-4 break-inside-avoid">
                ...
                <section className="mt-8 first:mt-0">
                    <div className="break-inside-avoid">
                        ...
                        <section className="mb-4 break-inside-avoid">
                            <header>
                                ...
                                <p className="text-zinc-600 dark:text-zinc-300 text-md">
                                    2014 – 2016 | Vocational training diploma (IEK) in Computer Science
                                </p>
                            </header>
                        </section>
                    </div>
                    <section className="mb-4 break-inside-avoid">
                        <header>
                            ...
                            <p className="text-zinc-600 dark:text-zinc-300 text-md">
                                2011 – 2014 | Vocational upper secondary school (EPAL) in Computer Science
                            </p>
                        </header>
                    </section>
                </section>
                    ...
                    <div className="break-inside-avoid">
                        ...
                        <section className="mb-4 break-inside-avoid">
                            ...
                            <div className="my-3 last:pb-2">
                                <ul className="flex flex-wrap -mb-2 -mr-2 leading-relaxed text-md">
                                    <Skill name="PHP" />
                                    <Skill name="MYSQL"/>
                    ...
                    <div className="break-inside-avoid">
                        ...
                        <section className="mb-4 break-inside-avoid">
                            <ul className="list-inside pr-7">
                                <SocialLink href="https://github.com/Erth0" target="_blank" icon={GitHubIcon}>
                                    https://github.com/Erth0
                                </SocialLink>
                                <SocialLink href="https://twitter.com/mukja_e" target="_blank" icon={TwitterIcon} className="mt-4">
                                ...
                                <SocialLink href="mailto:hey@mukja.dev" target="_blank"  icon={MailIcon} className="mt-4">
                                    hey@mukja.dev
                                </SocialLink>
                                <SocialLink href="https://www.google.com/maps/place/London/@51.5286416,-0.1015987,11z/data=!4m5!3m4!1s0x47d8a00baf21de75:0x52963a5addd52a99!8m2!3d51.5072178!4d-0.1275862" target="_blank" icon={LocationPinIcon} className="mt-4">
                                    London, United Kingdom
                                </SocialLink>
                                <SocialLink href="tel:07464816930" target="_blank" icon={TelephoneIcon} className="mt-4">
                                    (+44) 7464816930
                                </SocialLink>
                            </ul>
                        </section>
